...
namespace EfSamuari.App
{
    class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            //var samuarisWithInfo= GetSamuraiInfo(); 
            //samuarisWithInfo.ForEach(s => ch.Green(s.Name, s.RealName, s.BattleNames));
        ...
        private static void AddSomeSamurais()
        {
            ...
            // Lägg till flera samuarier mha AddRange
        ...
        private static void FindSamuraiWithRealName(string realName)
        {
            ...
            using (var context = new SamuraiContext())
            {
                var sam = context.Samurais.Where(s => s.SecretIdentity.RealName == realName).FirstOrDefault();
        ...
        private static void InvestigateWhenDatabaseIsQueried()
        {
            ...
            using (var context = new SamuraiContext())
            {
                ...
                ch.Green($"First samuari: {first.Name}");
        ...
        private static void InvestigateFindAndWhere(int samuraiId)
        {
            ...
            if (samurai == null)
            {
                ch.Red($"No samuari with id={samuraiId}");
            }
            else
            {
                ch.Green($"Samuari with id={samuraiId} has name={samurai.Name}");
            }
        ...
        private static void DeleteWhileTracked()
        {
            ...
            if (samurai == null)
            {
                ch.Red($"Samuari {nameToDelete} not found");
                return;
            }
            ...
            // Kräver att samuarien verkligen har det id'¨t
            // _context.Samurais.Remove(_context.Samurais.Find(1)); 

            _context.SaveChanges();

            ch.Green("Samuari removed");
        ...
        {
            // Ta bort en samuari med ett annat context, det funkar ändå
        ...
        {
            // Med FromSql kan du även anropa stored procedures (mot en entitet som Samuaris)
            ...
            // Hämtar en samuari där namnet innehåller en viss text 
        ...
        {
            // Lägg till "San" på den första Kalle-samuarien
            ...
            using (var contextNewAppInstance = new SamuraiContext())
            {
                ...
                contextNewAppInstance.Samurais.Update(samurai); // Detta context lyckas uppdatera den tidigare samuarien
                ch.Line("Before Save");
                contextNewAppInstance.SaveChanges();
                ch.Line("After Save");
            }
        ...
        private static void MultipleOperations()
        {
            ...
            // Lägg dessutom till två Samuarier till (Erik och Bob)
        ...
        {
            // Hämta alla samuarier från databasen
        ...
        {
            // Hämta en samuari från databasen
            // Modifiera
        ...
        private static void InvestigateIQuerable()
        {
            ...
            ch.Green($"elementType.Name = {elementType.Name}"); // ==> Samuari
        ...
        private static void GetBattlesForSamurai(string samuraiName)
        {
            ...
            // Med bara Include så är vi fast i Samuari
